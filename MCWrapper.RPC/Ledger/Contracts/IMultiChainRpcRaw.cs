...
namespace MCWrapper.RPC.Ledger.Clients
{
    ...
    public interface IMultiChainRpcRaw : IMultiChainRpc
    {
        ...
        /// <returns></returns>
        Task<RpcResponse<string>> AppendRawChangeAsync(string tx_hex, string address, [Optional] double native_fee);
        ...
        /// <param name="native_fee">Native currency value deducted from that amount so it becomes a transaction fee. Default - calculated automatically</param>
        /// <returns></returns>
        Task<RpcResponse<string>> AppendRawChangeAsync(string blockchainName, string id, string tx_hex, string address, [Optional] double native_fee);
        ...
        /// <returns></returns>
        Task<RpcResponse<string>> AppendRawDataAsync(string tx_hex, object data);
        ...
        /// <param name="data">(string or object, required) Data, see help data-all for details</param>
        /// <returns></returns>
        Task<RpcResponse<string>> AppendRawDataAsync(string blockchainName, string id, string tx_hex, object data);
        ...
        /// <returns></returns> 
        Task<RpcResponse<DecodeScriptResult>> DecodeScriptAsync(string script_hex);
        ...
        /// <param name="script_hex">The hex encoded script</param>
        /// <returns></returns>
        Task<RpcResponse<DecodeScriptResult>> DecodeScriptAsync(string blockchainName, string id, string script_hex);
        ...
        Task<RpcResponse<string>> SendRawTransactionAsync(string tx_hex, bool allow_high_fees = false);
        ...
        /// <param name="allow_high_fees">Allow high fees</param>
        /// <returns></returns>
        Task<RpcResponse<string>> SendRawTransactionAsync(string blockchainName, string id, string tx_hex, bool allow_high_fees = false);
