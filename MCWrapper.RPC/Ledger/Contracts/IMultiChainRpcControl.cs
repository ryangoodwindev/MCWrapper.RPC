...
namespace MCWrapper.RPC.Ledger.Clients
{
    /// <summary>
    /// 
    /// <para>MutliChain Core methods established by the IMultiChainRpcControl contract</para>
    ///
    ...
    public interface IMultiChainRpcControl : IMultiChainRpc
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<RpcResponse<GetInitStatusResult>> GetInitStatusAsync();
        ...
        /// <param name="id">String value to identify this transaction</param>
        /// <returns></returns>
        Task<RpcResponse<GetInitStatusResult>> GetInitStatusAsync(string blockchainName, string id);
