...
namespace MCWrapper.RPC.Ledger.Clients.Raw
{
    ...
    public class RawRpcClient : RpcConnection
    {
        ...
        /// <returns></returns>
        public async Task<RpcResponse<object>> AppendRawChangeAsync(string blockchainName, string id, string tx_hex, string address, [Optional] double native_fee)
        {
        ...
        /// <returns></returns>
        public async Task<RpcResponse<object>> AppendRawTransactionAsync(string blockchainName, string id, string tx_hex, object[] transactions, object addresses, [Optional] object[] data, string action = "")
        {
        ...
        /// <param name="action">Additional actions: "lock", "sign", "lock,sign", "sign,lock", "send"</param>
        /// <returns></returns>
        public async Task<RpcResponse<object>> CreateRawTransactionAsync(string blockchainName, string id, object[] transactions, object assets, [Optional] object[] data, string action = "")
        {
        ...
        /// <returns></returns>
        public async Task<RpcResponse<object>> GetRawTransactionAsync(string blockchainName, string id, string txid, [Optional] object verbose)
        {
        ...
        /// <returns></returns>
        public async Task<RpcResponse<object>> SendRawTransactionAsync(string blockchainName, string id, string tx_hex, bool allow_high_fees = false)
        {
